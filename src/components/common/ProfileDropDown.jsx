  ...
  return (
    <div className="absolute top-10 right-10 mt-2 w-60 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md z-50">
      <div className="flex items-center p-4 border-b dark:border-gray-700">
        ...
        />
        <div className="ml-3">
          <p className="text-sm font-medium text-gray-900 dark:text-gray-200">{name || 'Guest'}</p>
          <p className="text-xs text-gray-500 dark:text-gray-400">{email.length > 24?email.slice(0,18)+'...com':email || 'guest@example.com'}</p>
        </div>
      </div>
      <ul className="py-2">
